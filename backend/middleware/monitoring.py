...
class RequestMetrics:
    ...
    def get_summary(self) -> Dict:
        ...
        if self.response_times:
            avg_response_time = sum(r["duration_ms"] for r in self.response_times) / len(self.response_times)
    ...
    def get_prometheus_metrics(self) -> str:
        ...
        for endpoint, count in self.request_count.items():
            ...
            lines.append(f'keyforge_requests_total{{method="{method}",path="{path}"}} {count}')
