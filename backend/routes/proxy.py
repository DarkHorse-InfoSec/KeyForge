...
try:
    ...
    from ..proxy.credential_proxy import ProxyRequestHandler, ProxyTokenManager
    ...
    from backend.proxy.credential_proxy import ProxyRequestHandler, ProxyTokenManager
