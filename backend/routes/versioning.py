...
async def create_version(
    ...
    existing_versions = await db.credential_versions.find(
...
@router.get("/credentials/{credential_id}/versions", response_model=List[CredentialVersionResponse])
async def list_versions(
    ...
    versions = await db.credential_versions.find(
        {"credential_id": credential_id, "user_id": current_user["id"]}
...
@router.post("/credentials/{credential_id}/versions/{version_id}/rollback", response_model=CredentialVersionResponse)
...
@router.get("/credentials/{credential_id}/versions/current", response_model=CredentialVersionResponse)
