...
def validate_postgresql(key: str) -> dict:
    ...
    if err:
        return {"status": "invalid", "response_time": 0, "message": f"Invalid PostgreSQL credential: {err}"}
...
def validate_mysql(key: str) -> dict:
    ...
    err = _password_check(key)
    if err:
        return {"status": "invalid", "response_time": 0, "message": f"Invalid MySQL credential: {err}"}
...
def validate_redis(key: str) -> dict:
    ...
    err = _password_check(key)
    if err:
        return {"status": "invalid", "response_time": 0, "message": f"Invalid Redis credential: {err}"}
...
def validate_mongodb(key: str) -> dict:
    ...
    err = _password_check(key)
    if err:
        return {"status": "invalid", "response_time": 0, "message": f"Invalid MongoDB credential: {err}"}
